...
function changeMode() {
    ...
    if (i % 2 == 0) {
      ...
      document.getElementById("svgDark").style.display = "block";
    } else {
      document.getElementById("svgDark").style.display = "none";
      document.getElementById("svgLight").style.display = "block";
    }
    i += 1;
}
